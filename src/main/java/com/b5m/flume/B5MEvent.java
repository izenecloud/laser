...
public class B5MEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.b5m.flume.B5MEvent.Builder newBuilder() {
    return new com.b5m.flume.B5MEvent.Builder();
  }
  
  /** Creates a new B5MEvent RecordBuilder by copying an existing Builder */
  public static com.b5m.flume.B5MEvent.Builder newBuilder(com.b5m.flume.B5MEvent.Builder other) {
    return new com.b5m.flume.B5MEvent.Builder(other);
  }
  
  /** Creates a new B5MEvent RecordBuilder by copying an existing B5MEvent instance */
  public static com.b5m.flume.B5MEvent.Builder newBuilder(com.b5m.flume.B5MEvent other) {
    return new com.b5m.flume.B5MEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<B5MEvent>
    ...
    private Builder() {
      super(com.b5m.flume.B5MEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.b5m.flume.B5MEvent.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing B5MEvent instance */
    private Builder(com.b5m.flume.B5MEvent other) {
            super(com.b5m.flume.B5MEvent.SCHEMA$);
    ...
    /** Sets the value of the 'timestamp' field */
    public com.b5m.flume.B5MEvent.Builder setTimestamp(long value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'remoteAddress' field */
    public com.b5m.flume.B5MEvent.Builder setRemoteAddress(java.lang.CharSequence value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearRemoteAddress() {
      remoteAddress = null;
    ...
    /** Sets the value of the 'forwardAddress' field */
    public com.b5m.flume.B5MEvent.Builder setForwardAddress(java.lang.CharSequence value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearForwardAddress() {
      forwardAddress = null;
    ...
    /** Sets the value of the 'userAgent' field */
    public com.b5m.flume.B5MEvent.Builder setUserAgent(java.lang.CharSequence value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearUserAgent() {
      userAgent = null;
    ...
    /** Sets the value of the 'args' field */
    public com.b5m.flume.B5MEvent.Builder setArgs(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearArgs() {
      args = null;
    ...
    /** Sets the value of the 'internalArgs' field */
    public com.b5m.flume.B5MEvent.Builder setInternalArgs(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearInternalArgs() {
      internalArgs = null;
    ...
    /** Sets the value of the 'body' field */
    public com.b5m.flume.B5MEvent.Builder setBody(java.lang.CharSequence value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearBody() {
      body = null;
    ...
    /** Sets the value of the 'match' field */
    public com.b5m.flume.B5MEvent.Builder setMatch(boolean value) {
    ...
    public com.b5m.flume.B5MEvent.Builder clearMatch() {
